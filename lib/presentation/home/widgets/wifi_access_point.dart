...
class WifiAccessPointWidget extends StatefulWidget {
  const WifiAccessPointWidget({
    super.key,
    required this.SSID,
  ...
  @override
  State<StatefulWidget> createState() => _WifiAccessPointWidgetState();
}

class _WifiAccessPointWidgetState extends State<WifiAccessPointWidget> {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        FloatingActionButton(
          mini: true,
          key: const Key('wifi_access_point'),
          heroTag: 'wifi_access_point',
  ...
  Future<void> _searchDevices() async {
    if (_formKey.currentState!.validate()) {
      // The firmware exposes an Access Point at 192.168.4.1 ("soft" access point)
      ...
      // provide firmware with SSID and password to connect to WiFi
      ...
      // OPTIONAL: POST to 192.168.4.1/clear to reset SSID and password on the board
    }
  }
}
